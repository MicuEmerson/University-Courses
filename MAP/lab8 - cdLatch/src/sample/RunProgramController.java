...
public class RunProgramController {
    ...
    //LATCH TABLE
    @FXML private TableView<LatchTableView> LatchTable;
    @FXML private TableColumn<LatchTableView, Integer> LatchTableID;
    @FXML private TableColumn<LatchTableView, Integer> LatchTableNumber;
    ...
    public void initialize(){
        ...
        PrgState programState = new PrgState(exeStack, dict, list, null, fileTable, heap,latchTable,GenIDFork.getID());

        Repository repo = new Repository();
        repo.addPrgState(programState);
        ctrl = new Controller(repo);

        this.LatchTableID.setCellValueFactory(new PropertyValueFactory<>("address"));
        this.LatchTableNumber.setCellValueFactory(new PropertyValueFactory<>("value"));
    ...
    private void setLatchTable(){
        ...
        for(Integer key: programState.getLatchTable().getAll())
            list.add(new LatchTableView(key, programState.getLatchTable().get(key)));

        LatchTable.setItems(list);
    }

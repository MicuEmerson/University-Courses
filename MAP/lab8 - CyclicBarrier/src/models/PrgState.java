...
public class PrgState {
    ...
    private IBarrierTable<Integer, MyPair> barrierTable;
    private Integer ID;
    ...
    public PrgState(IExeStack<Statement> s, IDictionary<String, Integer> d, IList<Integer> l, Statement r,
                    ...
                    IBarrierTable<Integer, MyPair> barrierTable ,Integer ID){
        stack = s;
        dict = d;
        list = l;
        root = r;
    ...
    public IBarrierTable<Integer, MyPair> getBarrierTable() {
        return barrierTable;
    }

    public void setBarrierTable(IBarrierTable<Integer, MyPair> barrierTable) {
        this.barrierTable = barrierTable;
    }
